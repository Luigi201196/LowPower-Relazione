...
Si e' utilizzata la libreria a 45 nm, definito un segnale di clock di periodo corrispondente a 10 ns, si e' verificato il corretto inserimento tramite il comando \emph{report_clock} e si e' sintetizzato il circuito.\\
