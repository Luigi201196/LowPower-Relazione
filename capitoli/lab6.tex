...
Il VHDL implementato per questo scopo è presente in appendice, \ref{testbench_vhdl1} e \ref{testbench_vhdl2}.
\newpage
...
Di seguito un estratto del file disponibile in appendice fig. \ref.\\
\\
\textit{.......\\
.......\\
echo "testing v1..."\\
